exports.run = (client, message, args, interaction) => {
	const embed = new (require("discord.js").MessageEmbed)()
		...
		.addField(
			"Owners",
			"Sapphire 🌈#8305 (590286395143356417), what if#8183 (181244076970999808)"
		)
		.addField(
			"String writers",
	...
	try {
		message.author
			.send({ embed })
			.then(() => message.channel.send("I DMed you!"))
			.catch(() => message.channel.send("I tried but failed to DM you!"));
	} catch {}
