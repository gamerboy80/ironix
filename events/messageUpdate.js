...
if(!client.disabledFunctions.get(newMessage.guild.id).includes("filters")) {
  ...
  if (
    newMessage.guild.channels.cache.get(client.logs.get(newMessage.guild.id)) != undefined
  ) {
var res;
if(oldMessage.content.length > 1024) {
      ...
      ).then(res2 => res2.json().then(json2 => { key2 = json2[Object.keys(json2)[0]]; }));
    }
...
const embed = new (require("discord.js").MessageEmbed)()
    ...
    .setDescription("**Message edited in <#" + newMessage.channel.id + ">** [Jump to message](https://discord.com/channels/" + newMessage.guild.id + "/" + newMessage.channel.id + "/" + newMessage.id + ")")
    .addField("Old message:\n", ((oldMessage.content.length > 1024) ? "[Open message in a new tab]" + "(https://hastebin.com/" + key1  + ")" : oldMessage.content))
    .addField("New message:\n", ((newMessage.content.length > 1024) ? "[Open message in a new tab]" + "(https://hastebin.com/" + key2  + ")" : newMessage.content));

    newMessage.guild.channels.cache
        .get(client.logs.get(newMessage.guild.id)).send({ embed });
  }
  } else {
